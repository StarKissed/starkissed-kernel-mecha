...
struct s5k3h1gx_i2c_reg_conf s5k3h1gx_fast_video_settings_array_mipi[] =
{
	 { 0x0305 , 0x04 }, /* pre_pll_clk_div = 4 */
	 { 0x0306 , 0x00 }, /* pll_multiplier */
	 { 0x0307 , 0x66 }, /* pll_multiplier  = 160 */
	 { 0x0303 , 0x01 }, /* vt_sys_clk_div = 1 */
	 { 0x0301 , 0x05 }, /* vt_pix_clk_div = 10 */
	 { 0x030B , 0x01 }, /* op_sys_clk_div = 1 */
	 { 0x0309 , 0x05 }, /* op_pix_clk_div = 10 */
	 { 0x30CC , 0xA0 }, /* DPHY_band_ctrl 560 ~ 640Mbps */
	 { 0x0344 , 0x00 }, /* Xaddrstart 0 */
	 { 0x0345 , 0x00 },
	 { 0x0346 , 0x01 }, /* Yaddrstart 464 */
	 { 0x0347 , 0xd0 },
	 { 0x0348 , 0x0C }, /* Xaddrend 3261 */
	 { 0x0349 , 0xbd },
	 { 0x034A , 0x07 }, /* Yaddrend 1999 */
	 { 0x034B , 0xcf },
